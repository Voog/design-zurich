  ...
  <div class="site-container">
    ...
    <div class="container">
      ...
      <footer class="sections">
        ...
        <div class="feature-section {{ feature_4_wide }} js-bg-picker-area feature-4" data-section-name="feature_4">
          <div class="background-image js-background-image"></div>
          <div class="background-color js-background-color"></div>
          {% if editmode %}
          ...
          <div class="js-background-type {{ content_bg_4_type }}" style="width: 100%">
            <div class="wrap">
              <section class="feature-content content-formatted {% if site.branding.enabled %}voog-reference-separation{% endif %}" data-search-indexing-allowed="true">{% content name="feature_4" %}</section>
            </div>
