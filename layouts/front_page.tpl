  ...
  <div class="container">
    ...
    <footer class="sections">
      ...
      <div class="feature-section feature-3 js-bg-picker-area">
        <div class="background-image js-background-image"></div>
        <div class="background-color js-background-color"></div>
        {% if editmode %}<button class="voog-bg-picker-btn js-background-settings" data-bg-key="content_bg_3" data-bg-picture-boolean="true" data-target-width="600" data-bg-image="{{ content_bg_3_image }}" data-bg-image-sizes="{{ content_bg_3_image_sizes_str | escape }}" data-bg-color="{{ content_bg_3_color }}" data-bg-color-data="{{ content_bg_3_color_data_str | escape }}"></button>{% endif %}
      ...
      <div class="feature-section feature-4 js-bg-picker-area">
        <div class="background-image js-background-image"></div>
        <div class="background-color js-background-color"></div>
        {% if editmode %}<button class="voog-bg-picker-btn js-background-settings" data-bg-key="content_bg_4" data-bg-picture-boolean="true" data-target-width="600" data-bg-image="{{ content_bg_4_image }}" data-bg-image-sizes="{{ content_bg_4_image_sizes_str | escape }}" data-bg-color="{{ content_bg_4_color }}" data-bg-color-data="{{ content_bg_4_color_data_str | escape }}"></button>{% endif %}

        {% if site.branding.enabled %}
          <div class="js-background-type {{ content_bg_4_type }}">
            <div class="voog-reference">
              {% loginblock %}
                {{ "footer_login_link" | lc | replace_first: "Voog. ", "" }}
