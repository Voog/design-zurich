      ...
      <footer class="sections">
        ...
        <div class="feature-section {{ feature_4_wide }} js-bg-picker-area feature-4" data-section-name="feature_4">
          ...
          <div class="wrap js-background-type {{ content_bg_4_type }}">
            <section class="feature-content content-formatted {% if site.branding.enabled %}bottom-separation{% endif %}" data-search-indexing-allowed="true">{% content name="feature_4" %}</section>
          </div>
