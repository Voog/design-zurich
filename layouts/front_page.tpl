...
<body class="front-page">
  ...
  <div class="container">
    ...
    <footer class="sections {% if site.branding.enabled %}voog-reference-enabled{% endif %}">
      {% if feature_1_has_content or editmode %}
      ...
      {% if feature_2_has_content or editmode %}
      ...
      {% if feature_3_has_content or editmode %}
    ...
    {% if site.branding.enabled %}
      <div class="voog-reference {{ content_bg_transparent }} {{ voog_reference_bg_type }}">
        {% loginblock %}
