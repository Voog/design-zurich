:root {
  /* VoogStyle
    ...
    "scope": "global"
  */
  --global-content-background-color: #eee;
  /* VoogStyle
  ...
  */
  --global-menu-sub-font-size: 14px;
  /* VoogStyle
    "pathI18n": ["custom_styles.content", "custom_styles.sub_menu", "custom_styles.normal"],
  ...
  */
  --global-menu-sub-hover-color: #1b2124;
  /* VoogStyle
    "pathI18n": ["custom_styles.content", "custom_styles.sub_menu", "custom_styles.active"],
    "titleI18n": "custom_styles.color",
    "type": "button",
    ...
    "scope": "global"
  */
  --global-menu-sub-active-color: #1b2124;
  /* VoogStyle
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --global-content-body-text-color: #696b6c;
  /* VoogStyle
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --global-content-button-padding: 21px;
  /* VoogStyle
  "pathI18n": ["custom_styles.content", "custom_styles.button", "custom_styles.normal"],
  "titleI18n": "custom_styles.size",
  "editor": "rangePicker",
  ...
  */
  --global-content-button-font-size: 15px;
  /* VoogStyle
    "pathI18n": ["custom_styles.content", "custom_styles.button", "custom_styles.normal"],
    "titleI18n": "custom_styles.background_color",
    "editor": "colorPicker",
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --global-content-button-hover-background-color: black;
  /* VoogStyle
    "pathI18n": ["custom_styles.content", "custom_styles.button", "custom_styles.normal"],
    "titleI18n": "custom_styles.font_size",
    "type": "button",
  ...
  */
  ...
  /* VoogStyle
    ...
    "scope": "global"
  */
  --global-content-button-hover-color: white;
}
