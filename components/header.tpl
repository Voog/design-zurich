<header class="header {% if site.search.enabled %} search-enabled{% endif %}">
  ...
  <div class="header-container" data-section-name="main_feature">
    <div class="header-left js-header-left js-background-type {{ header_bg_type }}">
      {% unless front_page %}
    ...
    <div class="{% unless front_page %}header-right{% endunless %} js-header-right js-background-type {{ header_bg_type }}">
